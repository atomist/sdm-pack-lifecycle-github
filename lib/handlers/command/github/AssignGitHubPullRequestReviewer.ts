                    ...
                    if (err.message) {
                        ...
                        if (body.message.indexOf("Review cannot be requested from pull request author.") >= 0) {
                            return ctx.messageClient
                                .respond(slackWarningMessage("Review Pull Request",
                            ...
                            return ctx.messageClient.respond(slackErrorMessage("Review Pull Request", body.message, ctx))
                                .then(() => Success, failure);
                        }
                    }
                    return failure(err);
